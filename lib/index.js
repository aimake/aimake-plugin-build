...
var execute = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(config) {
    var aimakeOptions, options, webpackConfig, webpackOptions;
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            aimakeOptions = config.aimakeOptions, options = config.options, webpackConfig = config.webpackConfig, webpackOptions = config.webpackOptions;
